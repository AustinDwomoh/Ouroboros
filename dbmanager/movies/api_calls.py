...
def parse_movie(data):
    ...
    return {
        ...
        "in_collection": [{
            ...
            "poster_path": f"https://image.tmdb.org/t/p/w500{collection['poster_path']}" if collection.get("poster_path") else None,
            "backdrop_path": f"https://image.tmdb.org/t/p/w500{collection['backdrop_path']}" if collection.get("backdrop_path") else None,
        }] if collection else [],
    }
