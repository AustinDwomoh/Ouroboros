...
class Rpvp(commands.Cog):
    ...
    async def rpvp(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(
            "Please tag the player who will compete against you."
        )
        ...
        try:
            ...
            if match:
                ...
                if opponent and opponent.id != interaction.user.id:
                    ...
                    game_view = RPSView(interaction.user, opponent, 5, 1, 0, 0)
                    ...
                    await interaction.followup.send(
                        "You need to tag a valid opponent who is not yourself."
                    )
            else:
                await interaction.followup.send(
